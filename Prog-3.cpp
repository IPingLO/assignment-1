...
//  quicksort recursively sort
  void swapp(int *A,int i,int j)
  {
   ...
   void quicksort(int *A,int l,int r){
    	  if(l<r){
          int m=(l+r)/2;
          int old_pivot_position=0;
          int old_pivot_position_1= select_random_middle(A,l,l+2);
          int old_pivot_position_2= select_random_middle(A,m-1,m+1);
          int old_pivot_position_3= select_random_middle(A,r-2,r);
          if((old_pivot_position_1>old_pivot_position_2)&&(old_pivot_position_1<old_pivot_position_3))//old_pivot_position_1=middle
                   old_pivot_position=old_pivot_position_1;
          else if((old_pivot_position_2>old_pivot_position_1)&&(old_pivot_position_2<old_pivot_position_3))      //old_pivot_position_2=middle
                   old_pivot_position=old_pivot_position_2;
          else     old_pivot_position=old_pivot_position_3;
